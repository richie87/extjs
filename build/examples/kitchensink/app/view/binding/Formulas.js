Ext.define('KitchenSink.view.binding.Formulas', {
    ...
    //<example>
    exampleDescription: [
        '<p>This example shows data binding using formulas (calculated properties). This ',
        'example also demonstrates automatic dependency resolution between formulas that  ',
        'depend on each other\'s values.</p>'
    ],
    otherContent: [{
        type: 'ViewModel',
