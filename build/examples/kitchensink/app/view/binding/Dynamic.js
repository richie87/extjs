Ext.define('KitchenSink.view.binding.Dynamic', {
    ...
    //<example>
    exampleDescription: [
        '<p>This example shows simple dynamic data binding. When the data in the underlying view model is ',
        'modified, the change is relayed back to the panel and the markup is updated.</p>'
    ],
    otherContent: [{
        type: 'Controller',
