Ext.define('KitchenSink.view.binding.ChainedStores', {
    ...
    exampleDescription: [
        '<p>This example demonstrates a chained store, a store that is backed by the data of another store.</p>',
        '<p>Sorting and filtering of the stores are independent.</p>',
        '<p>Removing a value in the source store removes it from the chained store.</p>',
        '<p>Model instances are shared, so editing the data in one store will be reflected in the other.</p>'
    ],
    otherContent: [{
        type: 'ViewModel',
