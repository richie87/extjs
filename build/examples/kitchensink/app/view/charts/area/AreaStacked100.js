Ext.define('KitchenSink.view.charts.area.AreaStacked100', {
    extend: 'Ext.Panel',
    ...
    exampleDescription: [
        '100% stacked area are multi-series area charts where categories are stacked (percentage values) \
        on top of each other, with an additional category \'Others\' that is used to sum up the \
        various categories for each series to a perfect 100%.'
    ],
            ...
            series: [{
                ...
                tips: {
                    ...
                    renderer: function(storeItem, item) {
                        var browser = item.series.title[item.series.yField.indexOf(item.storeField)];
