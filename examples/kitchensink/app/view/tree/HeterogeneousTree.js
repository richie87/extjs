Ext.define('KitchenSink.view.tree.HeterogeneousTree', {
    ...
    exampleDescription: [
        '<p>This examples shows how heterogeneous models can be read into a TreeStore',
        ' offering the ability to have different entity types at different levels of a tree.</p>',
        '<p>The Model classes at each level of the tree are different types. So you can use ',
        'associated but different data types in your trees.</p>',
        '<p>The key to this is the <b><code>typeProperty</code></b> config on the Proxy\'s Reader.</p>',
        '<p>The toolbar is aware of the type of the selected node and knows what kind of new entity to add.</p>'
    ].join(''),
    //</example>
    store: 'GeoData',
    rootVisible: false,
