Ext.define('KitchenSink.view.enterprise.AmfGrid', {
    ...
    //<example>
    exampleDescription: [
        '<p>This example shows how to load a grid using Adobe AMF (Action Message Format) ',
        'data. It demonstrates the UTF-8 decoder by loading pangrams in several languages.</p>',
        '<p>AMF support is available only in the Enterprise Edition.</p>'
    ],
    otherContent: [{
        type: 'Model',
