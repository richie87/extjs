Ext.define('KitchenSink.view.enterprise.SoapGrid', {
    ...
    //<example>
    exampleDescription: [
        '<p>This example shows how to load a grid with SOAP data, and how to use a SOAP ',
        'reader to parse records from an xml response that contains namespace prefixes.</p>',
        '<p>SOAP support is available only in the Enterprise Edition.</p>'
    ],
    otherContent: [{
        type: 'Model',
