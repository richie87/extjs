Ext.define('KitchenSink.view.charts.touch.CandlestickChart', {
    extend: 'Ext.panel.Panel',
    xtype: 'candlestick-chart',
    ...
    //<example>
    exampleDescription: [
        '<p>This example shows how to create a Candlestick chart.</p>',
        '<p>Candlestick charts are financial charts that allow to visualize the open/high/low/close values of a stock.</p>',
