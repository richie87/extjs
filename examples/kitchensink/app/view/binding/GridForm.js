Ext.define('KitchenSink.view.binding.GridForm', {
    ...
    //<example>
    exampleDescription: [
        '<p>This example demonstrates being able to change the binding at runtime. The company binds to the form ',
        'and as each record is selected the form is populated. As the form values change, the record is updated.</p>'
    ],
    themes: {
        classic: {
            green: 'green',
