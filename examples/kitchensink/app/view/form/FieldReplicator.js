Ext.define('KitchenSink.view.form.FieldReplicator', {
    ...
    exampleDescription:
        '<p>This example illustrates the use of plugins to alter the default ' +
        'behaviour of Components. The <b>Send To</b> field clones itself until ' +
        'the final one is left blank to allow multiple mail recipients. The layout ' +
